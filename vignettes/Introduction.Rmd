...
In order to render a single modal window from R markdown to html, the function to 
use is [generate_html_4_rmd()](../reference/generate_html_4_rmd.html). The function expects the full path of the R markdown file to be rendered, such as in the following example:
...
csv_SST <- "/Users/jai/Documents/cinms/data/oceano/statistics_sst_cinms.csv"
